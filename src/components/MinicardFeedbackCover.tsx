...
export function MinicardFeedbackCover() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center bg-neutral-100 p-6">
      <div className="relative h-[360px] w-[195px] rounded-[2.25rem] bg-neutral-900 p-2 shadow-xl">
        <div className="absolute -right-[2px] top-24 h-10 w-[3px] rounded-r bg-neutral-800" />
        <div className="absolute -left-[2px] top-16 h-6 w-[3px] rounded-l bg-neutral-800" />
        <div className="absolute -left-[2px] top-24 h-10 w-[3px] rounded-l bg-neutral-800" />

        <div className="relative h-full w-full overflow-hidden rounded-[1.65rem] bg-white">
          <div className="absolute left-1/2 top-0 z-20 h-4 w-16 -translate-x-1/2 rounded-b-lg bg-neutral-900" />

          <div className="flex items-center justify-between px-4 pt-2.5 text-[9px] font-medium text-neutral-900">
            <span>9:41</span>
            <span className="flex items-center gap-0.5 text-[8px]">▂▄▆ ᯓ ▮</span>
          </div>
          ...
          <div className="relative h-[calc(100%-26px)] overflow-hidden">
            ...
            >
              ...
              <button className="mt-auto mb-3 w-full rounded-full bg-indigo-600 py-1.5 text-[11px] font-medium text-white">
                Entendido
              </button>
            </div>
          </div>

          <div className="absolute bottom-1.5 left-1/2 h-1 w-16 -translate-x-1/2 rounded-full bg-neutral-300" />
        </div>
      </div>
    </div>
  )
