...
const highlightPhrases = ['tu tarjeta virtual', 'beneficios exclusivos']
const highlightPattern = new RegExp(
  `(${highlightPhrases.join('|')})`,
  'g',
)

function renderRich(text: string) {
  return text.split(highlightPattern).map((part, i) =>
          ...
          <div className="mt-1 w-full rounded-2xl border border-neutral-200 bg-white p-4 shadow-md">
            ...
            <dl className="mt-3 divide-y divide-neutral-100 text-sm">
              <div className="flex items-center justify-between py-2">
                ...
                <dd className="font-medium text-neutral-900">$ 1.000.000</dd>
              </div>
              <div className="flex items-center justify-between py-2">
              ...
              <div className="flex items-center justify-between py-2">
                ...
                <dd className="font-medium text-neutral-900">Día 12 de cada mes</dd>
              </div>
              <div className="flex items-center justify-between py-2">
                <dt className="text-neutral-500">Enviar tarjeta a</dt>
                <dd className="font-medium text-neutral-900">Zeballos 2435, Beccar</dd>
              </div>
            </dl>
